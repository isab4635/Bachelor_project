...
#Script to run logistic regression, random forest, and decision tree models on the biologic dataset with redundant features removed.
...
# Settings
path = "../../data/"
outdir = "../../results/bio_models/removed_red/"
...
axs[1].legend()
plt.savefig(outdir + "removed_red_roc_pr.png")
plt.close()
