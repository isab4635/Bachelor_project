...
# Script with statistical analysis of the features for the mtx subquestion. 
# It computes summary statistics, performs statistical tests, calculates AUC-ROC for each feature, and creates visualizations such as violin plots 
