...
# Script for training and evaluating scaled versions of the baseline models for biologic_added, including logistic regression, random forest, and decision tree. Evaluation includes ROC and PR curves, as well as confusion matrix and other metrics. This allows us to compare the performance of scaled features against the original baseline models.
...
axs[1].legend()
plt.savefig(outdir + "scaled_roc_pr.png")
plt.close()
