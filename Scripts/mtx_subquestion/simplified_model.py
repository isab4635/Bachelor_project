...
if label == "mtx_stopped":
    ...
    raise ValueError("Label must be either 'mtx_success' or 'biologic_added'")

# Drop features strongly correlated with SDAI
...
axs[1].legend()
plt.savefig(outdir + "simpler_model_roc_pr.png")
